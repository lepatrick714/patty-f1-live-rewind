...
export const GearDisplay = ({ gear, color = '#10B981' }: GearDisplayProps) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative h-40 w-24 overflow-hidden rounded-xl border-2 border-gray-800 bg-gradient-to-b from-gray-900 to-gray-950 shadow-2xl">
        {/* Top shine effect */}
        <div className="pointer-events-none absolute left-0 right-0 top-0 h-20 bg-gradient-to-b from-white/5 to-transparent" />

        {/* Gear indicators */}
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-1 py-3">
          {gears.map(g => {
            const isActive = gear === g;
            return (
              <div
                key={g}
                className={`relative flex h-6 w-16 items-center justify-center rounded-md text-sm font-black transition-all duration-200 ${
        ...
        {/* Side accent lines */}
        <div className="absolute bottom-3 left-1 top-3 w-0.5 rounded-full bg-gradient-to-b from-transparent via-gray-700 to-transparent" />
        <div className="absolute bottom-3 right-1 top-3 w-0.5 rounded-full bg-gradient-to-b from-transparent via-gray-700 to-transparent" />
      </div>

      {/* Current gear display below */}
      <div className="absolute -bottom-12 left-1/2 min-w-[80px] -translate-x-1/2 text-center">
        <div
        ...
        <div className="mt-1 text-[10px] font-semibold tracking-wider text-gray-500">
          GEAR
        </div>
      </div>
    </div>
